                ...
                <>
                  ...
                  {sidebar.loading ? (
                    ...
                    <>
                      ...
                      {(localResults.length === 0 || (sidebar.selectedTag === 'Favorites' && !localResults.some(item => item != null))) && (
                        <div className="text-center">
                          <div className="mb-3">
                            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gray-30">
                              {sidebar.selectedTag === 'Favorites' ? (
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="w-6 h-6 text-gray-110">
                          ...
                          <h3 className="text-sm font-medium text-gray-190 mb-4">
                            {sidebar.selectedTag === 'Favorites' ? 'No favorite results found' : 'No results found'}
                          </h3>
                        </div>
                      )}
                      ...
                      {/* Always show "No results found" message when there are no library results but user has searched */}
                      {(totalLibraryCount === 0 && sidebar.searchQuery.trim() !== '') && (
